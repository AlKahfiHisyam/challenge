...
@section('head')
    <!-- Daterangepicker -->
    <link rel="stylesheet" href="{{ url('assets2/vendors/datepicker/daterangepicker.css') }}" type="text/css">
                    ...
                    <div class="card-scroll" style="height: 430px">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="../assets2/assets/media/image/user/man_avatar1.jpg"
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="../assets2/assets/media/image/user/man_avatar2.jpg"
                                             class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="../assets2/assets/media/image/user/man_avatar3.jpg"
                                             class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="../assets2/assets/media/image/user/man_avatar4.jpg"
                                             class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
            ...
            <div class="table-responsive">
                <table id="recent-orders" class="table">
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product1.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product2.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product3.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product4.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product5.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product6.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product7.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product8.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../assets2/assets/media/image/products/product9.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="../../assets2/assets/media/image/products/product10.png"
                ...
                <div class="modal-body text-center">
                    <div class="row my-3">
                        <div class="col-md-6 ml-auto mr-auto">
                            <figure>
                                <img class="img-fluid" src="{{ url('assets2/assets/media/svg/upgrade.svg') }}" alt="upgrade">
                            </figure>
                        </div>
                    </div>
...
@section('script')
    <!-- Apex chart -->
    <script src="{{ url('assets2/vendors/charts/apex/apexcharts.min.js') }}"></script>

    <!-- Daterangepicker -->
    <script src="{{ url('assets2/vendors/datepicker/daterangepicker.js') }}"></script>

    <!-- DataTable -->
    <script src="{{ url('assets2/vendors/dataTable/datatables.min.js') }}"></script>

    <!-- Dashboard scripts -->
    <script src="{{ url('assets2/assets/js/examples/pages/dashboard.js') }}"></script>
@endsection
