        ...
        <div class="header-container">
            <div class="header-left">
                ...
                <div class="header-logo">
                    <a href="{{ url('/') }}">
                        <img class="logo" src="{{ url('assets2/assets/media/image/logo.png') }}" alt="logo">
                    </a>
                </div>
            </div>
                                ...
                                <div class="dropdown-scroll">
                                    <div class="list-group list-group-flush">
                                        <a href="#" class="px-4 py-3 list-group-item d-flex">
                                            <div class="flex-shrink-0">
                                                <figure class="avatar mr-3">
                                                    <img class="rounded" src="{{ url('assets2/assets/media/image/products/product6.png') }}"
                                        ...
                                        <a href="#" class="px-4 py-3 list-group-item d-flex">
                                            <div class="flex-shrink-0">
                                                <figure class="avatar mr-3">
                                                    <img class="rounded" src="{{ url('assets2/assets/media/image/products/product3.png') }}"
                                                         alt="pineapple">
                                                </figure>
                                            </div>
                                            <div class="flex-grow-1">
                                        ...
                                        <a href="#" class="px-4 py-3 list-group-item d-flex">
                                            <div class="flex-shrink-0">
                                                <figure class="avatar mr-3">
                                                    <img src="{{ url('assets2/assets/media/image/products/product7.png') }}"
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" title="User menu" data-toggle="dropdown">
                                <figure class="avatar avatar-sm">
                                    <img src="{{ url('assets2/assets/media/image/user/man_avatar3.jpg') }}"
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <span class="nav-link-icon">
                        ...
                        <ul>
                            <li>
                                <a href="{{ url('/Toko/List_Toko') }}">Data Toko</a>
                            </li>
                            <li>
                                <a href="{{ url('/Toko/InputAwal') }}">Tambah List Toko</a>
                            </li>
                            <li>
                                <a href="{{ url('/Toko/InputKunjungan') }}">Kunjungan</a>
                            </li>
                        </ul>
                    </li> 
                    <li>
